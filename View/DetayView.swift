...
struct DetayView: View {
    ...
    var body: some View {
        VStack {
            OzelImage(url: filmDetayViewModel.filmDetail?.poster ?? "Ozel Image gösterilecek").frame(width: UIScreen.main.bounds.width*0.7, height: UIScreen.main.bounds.height*0.35, alignment: .center)
